...
bucket = storage_client.bucket('news-platform-demo-storage')

# Free news API (NewsAPI has free tier)
NEWS_API_KEY = os.environ.get('NEWS_API_KEY', 'YOUR_API_KEY')  # Get from newsapi.org
